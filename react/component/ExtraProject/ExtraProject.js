...
export default function ExtraProject(props) {
    ...
    return <a href={`${props.project_link}`} className={classes.a_container} target="_blank" rel="noreferrer">
        <div className={classes.project_text} >
            ...
            <div className={classes.project_sources}>
                <a href={`${props.project_link}`} target="_blank" rel="noreferrer">
                ...
                <a href={`${props.hosted_link}`} target="_blank" rel="noreferrer" onClick={(e) => {
                    if (props.hosted_link === "N/A") {
                        e.preventDefault();
                        notifContext.showNotification("Unfortunately the project is not hosted !!", 3000, "Error");
                    }
                }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
